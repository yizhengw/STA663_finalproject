...
plt.show()
fig.savefig('original_plots_duke_regular.png')
...
fig.savefig('simulation_duke_regular.png')
...
fig.savefig('mcmc_result_real_duke.png')
plt.show()
...
plt.show()
fig.savefig("final_result_simple_duke.png")
